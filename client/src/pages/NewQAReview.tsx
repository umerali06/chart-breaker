...
const NewQAReview: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await qaApi.createReview(reviewData);
      
      setSuccessMessage('QA review created successfully!');
      ...
      console.error('Error creating QA review:', err);
      setError(err.response?.data?.message || 'Failed to create QA review');
    } finally {
      setLoading(false);
    }
  };
